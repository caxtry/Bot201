...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    // let premiumUsers = new Set(['991830733733769327', '1024032335181652048', '720756689522917488', '1023581883944161301', '897531193153691658']);
    // // add a user to the premium list
    // function addPremiumUser(userID) {
    //   premiumUsers.add(userID);
    //   console.log(`npm add ${userID} premium`);
    // }
    ...
    // if (!hasPremiumAccess(message.author.id)) {
    //   return message.reply('you do not have premium access to use this command');
    // }
    ...
    try {
      ...
      return message.channel.send({ embeds: [new Discord.MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle(eval(client.la[ls]["handlers"]["setup-aichatjs"]["setup-aichat"]["variable4"]))] });
    }
  }
};