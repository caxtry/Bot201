...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let caxtrydc = client.guilds.cache.get("988591652220313672")
      let caxtrymembers = await caxtrydc.members.fetch().catch(() => { });
      let partnercount = caxtrymembers.filter(m => m.roles.cache.has("1106462035941802066"))
      ...
      let MenuEmbed = new Discord.MessageEmbed()
        .setColor(es.color)
        .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/3HuUY988hV")
