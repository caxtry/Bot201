    ...
    client.on("messageCreate", async (message) => {
     try{
        ...
        async function LEVELUP() {
            ...
            ctx.fillStyle = "#0368f2";
            const bgimg = await Canvas.loadImage("./assets/levelup4.png");
...
*/
                 ...
                 */
                const bg = await Canvas.loadImage("./assets/base4.png")
                ...
                DrawProgressionBar("#3a56f2", "#4bf3ff", 1550, 850, 2000, 125, xp_data.text.current, xp_data.text.needed, 3475, 835, "TEXT")
                DrawProgressionBar("#3a56f2", "#4bf3ff", 1550, 1985, 2000, 125, xp_data.voice.current, xp_data.voice.needed, 3475, 1970, "VOICE")
